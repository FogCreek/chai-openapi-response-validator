...
module.exports = function(pathToOpenApiSpec, responseValidatorOptions = {}) {
  ...
  return function (chai) {
    ...
    Assertion.addProperty('satisfyApiSpec', function () {
      ...
      const validationError = validateResAgainstApiSpec(res, expectedResponse, openApiSpec, responseValidatorOptions);
...
function validateResAgainstApiSpec(res, expectedResponse, openApiSpec, responseValidatorOptions) {
